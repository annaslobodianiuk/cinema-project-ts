...
export default function CardPage() {
  ...
  const { data, isLoading } = useGetMovieByIdQuery(idFilm[2]);
  ...
  return (
    <div className="relative py-[40px] px-[60px] md:px-[30px] lg:px-[60px] xl:px-[80px] bg-blue-950">
      <div className="grid grid-cols-1 md:grid-cols-2 place-items-center py-[30px] px-[20px] sm:px-[50px] md:px-[25px] lg:px-[50px] xl:py-[50px] xl:px-[70px] text-white border-2 rounded-xl border-white z-10">
